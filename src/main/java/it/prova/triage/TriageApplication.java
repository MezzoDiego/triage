...
public class TriageApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		if (utenteServiceInstance.findByUsername("operator") == null) {
			Utente specialPlayer = new Utente("operator", "operator", "Antonio", "Verdi", LocalDate.now());
			specialPlayer.getRuoli()
					.add(ruoloServiceInstance.cercaPerDescrizioneECodice("Operator", Ruolo.ROLE_SUB_OPERATOR));
